...
const rowStyles = StyleSheet.create({
  ...
  value: { fontSize: 13, fontWeight: '600', color: '#1A3C5E' },
});
...
const s = StyleSheet.create({
  ...
  price: { fontSize: 14, fontWeight: '700', color: '#1A3C5E', fontFamily: FONTS.inter.bold },
  perNight: { fontSize: 12, color: '#94A3B8' },
  ratingBadge: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  ratingText: { fontSize: 12, fontWeight: '700', color: '#1A3C5E' },
  breakdown: { gap: 4 },
  totalRow: {
  ...
  placeholder: { fontSize: 12, color: '#94A3B8', textAlign: 'center', paddingVertical: 8 },
});
