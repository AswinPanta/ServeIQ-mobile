...
- `Samip-khatri/ServeIQ-Booking` is a separate Vite+React frontend (not backend) — see Related Repos below
...
All four ServeIQ repos — check for updates by comparing commit counts below against GitHub (as of 2026-07-31):
...
- **`Thadaw/ServeIQ2.0`** — **active** Vite+React web frontend (`my-react-app/`). 27 commits. Latest (Jul 31): my-booking + booking details; (Jul 30) browse-by-property-type API; (Jul 29) Stripe; (Jul 28) Razorpay, booking confirmation, guest detail; (Jul 27) search/property/available-rooms API.
- **`Samip-khatri/ServeIQ-booking`** — Vite+React frontend. 8 commits. Latest (Jul 30): dashboard fetching real-time property data.
- **`Thadaw/ServeIQ`** — stale, 11 commits, last commit Jul 3, `/pms` route prefix. **Superseded by `Thadaw/ServeIQ2.0`.**
...
**Gap analysis (vs Thadaw/ServeIQ2.0 + Samip-khatri/ServeIQ-booking)**
