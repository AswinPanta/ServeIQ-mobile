...
const EXPORT_TYPES = [
  { icon: 'hotel' as const, title: 'Tenants', description: 'Export all tenant data with subscription details', formats: ['CSV', 'Excel'], color: '#3B82F6' },
...
const STATUS_STYLES: Record<string, { bg: string; text: string }> = {
  Completed: { bg: '#10B98112', text: '#10B981' },
  Processing: { bg: '#F59E0B12', text: '#F59E0B' },
  Failed: { bg: '#EF444412', text: '#EF4444' },
};
...
function buildCsvFor(title: string): { filename: string; content: string } {
  ...
  if (title === 'Bookings') {
    ...
    for (let i = 0; i < 24; i++) {
      ...
      rows.push(`BK-2026-${(1000 + i).toString()},Guest ${i + 1},StayEasy Hotel,${inD},${outD},${(8000 + i * 950).toString()},${i % 3 === 0 ? 'confirmed' : 'checked_in'}`);
    }
  ...
  const lines = [
    ...
    'occupancy_pct,72',
    '',
    '// Generated by StayEasy SuperAdmin',
  ];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll} contentInsetAdjustmentBehavior="automatic">
        ...
        <View style={s.historyCard}>
          ...
          {history.map((h, i) => {
            ...
            return (
              <View key={`${h.filename}-${i}`} style={[s.historyRow, i < history.length - 1 && { borderBottomWidth: 1, borderBottomColor: '#F1F5F9' }]}>
...
const s = StyleSheet.create({
  ...
  exportCard: { padding: 16, borderRadius: 16, backgroundColor: '#FFF', borderLeftWidth: 4, borderWidth: 1, borderColor: '#F1F5F9' },
  exportHead: { flexDirection: 'row', gap: 12, marginBottom: 12 },
  iconWrap: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  exportTitle: { fontSize: 15, fontWeight: '700', color: '#0F172A' },
  exportDesc: { fontSize: 13, color: '#64748B', marginTop: 3 },
  ...
  historyCard: { padding: 18, borderRadius: 16, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#F1F5F9' },
