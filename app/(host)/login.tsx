      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.headerSection}>
          ...
          <View style={s.brandRow}>
            <IconSymbol name="hotel" size={28} color={SRS.navy} />
            <Text style={s.brandName}>StayEasy</Text>
          </View>
          <Text style={s.title}>Host Login</Text>
          <Text style={s.subtitle}>Sign in to manage your properties</Text>
        </View>
        ...
        <TouchableOpacity onPress={handleDemoLogin} disabled={isLoading} style={s.secondaryBtn} activeOpacity={0.85}>
          ...
          <Text style={s.secondaryBtnText}>Continue as Demo Host</Text>
        </TouchableOpacity>

        {/* Register Link */}
        <View style={s.linkRow}>
          <Text style={s.linkLabel}>New here?</Text>
          <TouchableOpacity disabled={isLoading} onPress={() => router.push('/(host)/register')}>
            <Text style={s.linkAction}>Create Account</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
...
const s = StyleSheet.create({
  ...
  toggleText: { fontSize: 13, fontWeight: '600', color: SRS.teal },
  ...
  secondaryBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: SPACING.sm, paddingVertical: 14, borderRadius: RADIUS.modal, borderWidth: 1.5, borderColor: SRS.teal + '40', backgroundColor: '#FFF' },
  secondaryBtnText: { fontSize: 14, fontWeight: '600', color: SRS.teal },
